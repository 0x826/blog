...
- 按 `claimFrequency` 冷却后领取 `claimAmount`
- 可选推荐人与推荐奖金
- Owner：注资、改参数、暂停、黑名单、紧急提款

```solidity
// SPDX-License-Identifier: MIT
// Verified on Optimism: 0x7d89945e58efb941c118d566946b995c0fbe5221
// https://optimistic.etherscan.io/address/0x7d89945e58efb941c118d566946b995c0fbe5221#code
